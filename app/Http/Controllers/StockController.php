...
class StockController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('stock.index',compact('stocks','title'));
    }
    ...
    public function show($id,Request $request)
    {
        ...
        if($request->ajax())
        {
            return URL::to('stock/'.$id);
        }

        $stock = Stock::findOrfail($id);
        return view('stock.show',compact('title','stock'));
    }
    ...
    public function edit($id,Request $request)
    {
        ...
        if($request->ajax())
        {
            return URL::to('stock/'. $id . '/edit');
        }

        
        $stock = Stock::findOrfail($id);
        return view('stock.edit',compact('title','stock'  ));
    }
